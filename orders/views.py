...
def place_order(request, total=0, quantity=0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'store/cart/checkout/payment.html', context)
    else:
        return redirect('store:store')
...
def payments(request):
    ...
    message = render_to_string('store/cart/checkout/payment_recieved_email.html', {
        'user': request.user,
        'order':order,
    })
...
def order_complete(request):
    ...
    try:
        ...
        return render(request, 'store/cart/order_complete/order_complete.html', context)
