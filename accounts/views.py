...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            message = render_to_string('store/accounts/email_activate/account_verification_email.html', {
                'user': user,
                'domain': current_site,
...
def dashboard(request):
    ...
    return render(request, 'store/accounts/dashboard/dashboard.html', context)
...
def my_orders(request):
    ...
    return render(request, 'store/accounts/dashboard/my_orders.html', context)
...
def edit_profile(request):
    ...
    return render(request, 'store/accounts/dashboard/edit_profile.html', context)
...
def change_password(request):
    if request.method == 'POST':
        ...
        if new_password == repeat_new_password:
            ...
            return redirect('accounts:change_password')
    return render(request, 'store/accounts/dashboard/change_password.html')
...
def order_detail(request,order_id):
    ...
    return render(request, 'store/accounts/dashboard/order_detail.html', context)
...
def forget_password(request):
    if request.method == 'POST':
        ...
        if Account.objects.filter(email=email).exists():
            ...
            message = render_to_string('store/accounts/forget_password/send_resetpassword_email.html', {
                'user': user,
                'domain': current_site,
                'uid': urlsafe_base64_encode(force_bytes(user.pk)),
                'token': account_activation_token.make_token(user),
    ...
    return render(request, 'store/accounts/forget_password/forget_password.html')
...
def resetpassword_validate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        messages.warning(request, 'Reset password now!')
...
def reset_password(request):
    if request.method == 'POST':
        ...
        return render(request, 'store/accounts/forget_password/reset_password.html')